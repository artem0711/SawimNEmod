...
public class VkApp {
    ...
    public VkApp(Context context) {
        ...
        setListener(new VkDialogListener() {
            ...
            public void onComplete(String url) {
                ru.sawimmod.modules.DebugLog.println("token " + url);
                _vkSess.deserialize(url.substring(url.indexOf("#") + 1));
            }

            @Override
            public void onError(String description) {
                ru.sawimmod.modules.DebugLog.println("error " + description);
                error = true;
            }
        });
    }
    ...
    private JSONObject request(String uri) {
        ...
        try {
            ...
            ru.sawimmod.modules.DebugLog.println("result " + responseText);
            ...
            _vkSess.resetAccessToken();
            ru.sawimmod.modules.DebugLog.panic("uri" + uri, ioex);
            return null;
        }
    }
    ...
    public boolean hasAccessToken() {
        ...
        try {
            ...
            ru.sawimmod.modules.DebugLog.panic("hasAccessToken", e);
        }
        return false;
    }
