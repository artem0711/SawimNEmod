...
class Preview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            ru.sawimmod.modules.DebugLog.panic("surfaceCreated", e);
        }
    }
    ...
    public Camera.Size getPref(List<Camera.Size> sizes, int w, int h) {
        ...
        if (null != sizes) {
            for (Camera.Size size : sizes) {
                ru.sawimmod.modules.DebugLog.println("size " + size.width + " " + size.height);
        ...
        ru.sawimmod.modules.DebugLog.println("_ " + pref.width + " " + pref.height + " " + w + " " + h);
        return pref;
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        try {
            ...
            ru.sawimmod.modules.DebugLog.panic("surfaceChanged def", e);
            try {
                setParameters(parameters.getSupportedPreviewSizes(), parameters.getSupportedPictureSizes(), w, h);
            } catch (Exception ex) {
                ru.sawimmod.modules.DebugLog.panic("surfaceChanged opt", ex);
            }
        }
        try {
            camera.setPreviewDisplay(holder);
            ...
            ru.sawimmod.modules.DebugLog.panic("surfaceChanged camera", e);
        }
    }
